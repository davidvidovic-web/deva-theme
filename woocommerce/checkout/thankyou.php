...
echo '<script>console.log("DEVA Thank You Template Loaded!");</script>';
?>
        ...
        <?php else : ?>
            ...
            <div class="deva-support-info">
                ...
                <div class="deva-contact-options">
                    <a href="mailto:support@deva.com" class="deva-contact-link">
                    ...
                    <a href="tel:+1234567890" class="deva-contact-link">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="deva-thankyou-actions">
                ...
                <button onclick="window.print()" class="deva-btn deva-btn-secondary">
                    <?php esc_html_e( 'Print Order', 'hello-elementor-child' ); ?>
                </button>
            </div>
    ...
    <?php else : ?>
        ...
        <div class="deva-thankyou-header deva-order-notfound">
            ...
            <div class="deva-thankyou-actions">
                ...
                <a href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>" class="deva-btn deva-btn-secondary">
                    <?php esc_html_e( 'My Account', 'hello-elementor-child' ); ?>
                </a>
            </div>
        </div>
